...
global.prefa = ['', '!', '.', ',', '🐤', '🗿'];
global.owner = ['2349130189955'];
global.ownMain = '2349130189955';
global.NamaOwner = 'Death'; // Do not change 
global.sessionName = 'session';
global.connect = true; // Set to false if using QR Code
global.namabot = 'Death'; // Do not change
global.author = 'DEATH'; // Do not change
